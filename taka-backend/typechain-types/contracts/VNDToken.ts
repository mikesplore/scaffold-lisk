...
export interface VNDTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_SUPPLY"
      | "allowance"
  ...
  encodeFunctionData(
    functionFragment: "donateToCharity",
    values: [AddressLike, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "donationTaxDeductionRates",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export namespace CharityRegisteredEvent {
  export type InputTuple = [
    charity: AddressLike,
    taxDeductionRate: BigNumberish
  ];
  export type OutputTuple = [charity: string, taxDeductionRate: bigint];
  export interface OutputObject {
    charity: string;
    taxDeductionRate: bigint;
  }
  export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
  export type Filter = TypedDeferredTopicFilter<Event>;
  export type Log = TypedEventLog<Event>;
...
export interface VNDToken extends BaseContract {
  connect(runner?: ContractRunner | null): VNDToken;
  waitForDeployment(): Promise<this>;

  interface: VNDTokenInterface;
  ...
  donateToCharity: TypedContractMethod<
    [charity: AddressLike, amount: BigNumberish],
    [boolean],
    "nonpayable"
  >;

  donationTaxDeductionRates: TypedContractMethod<
    [arg0: AddressLike],
    [bigint],
    "view"
  >;
  ...
  registerCharity: TypedContractMethod<
    [charity: AddressLike, taxDeductionRate: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "donateToCharity"
  ): TypedContractMethod<
    [charity: AddressLike, amount: BigNumberish],
    [boolean],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "donationTaxDeductionRates"
  ...
  filters: {
    ...
    "DonationMade(address,address,uint256,uint256)": TypedContractEvent<
      DonationMadeEvent.InputTuple,
      DonationMadeEvent.OutputTuple,
      DonationMadeEvent.OutputObject
    >;
