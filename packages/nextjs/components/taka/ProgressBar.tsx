...
export const ProgressBar: React.FC<ProgressBarProps> = ({
  ...
  const colorClasses = {
    emerald: "from-taka-primary-400 via-taka-primary-500 to-taka-primary-600",
    teal: "from-taka-teal-400 via-taka-teal-500 to-taka-teal-600", 
    amber: "from-taka-accent-400 via-taka-accent-500 to-taka-accent-600",
  }[color];
