...
const StickyNavigation = ({ activeSection, connectedAddress }: { activeSection: string; connectedAddress?: string }) => {
  const navItems = [
    { id: "hero", label: "Home" },
...
const Dashboard: NextPage = () => {
  ...
  return (
    <>
      <StickyNavigation activeSection={activeSection} connectedAddress={connectedAddress} />
