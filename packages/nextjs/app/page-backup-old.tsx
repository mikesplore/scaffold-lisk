  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-60 -right-60 w-96 h-96 bg-taka-primary-500/10 rounded-full blur-3xl animate-gentleFloat"></div>
        <div className="absolute -bottom-60 -left-60 w-96 h-96 bg-taka-accent-500/10 rounded-full blur-3xl animate-gentleFloat" style={{ animationDelay: "3s" }}></div>
        <div className="absolute top-1/3 right-1/3 w-80 h-80 bg-taka-teal-500/8 rounded-full blur-3xl animate-gentleFloat" style={{ animationDelay: "6s" }}></div>
      </div>
      ...
      <div className="relative z-10 container mx-auto px-6 py-12 space-y-12">
        ...
        {/* Progress Tracking - Better spacing and styling */}
        ...
        {/* Community Impact - Enhanced design */}
        <div className="glass p-10">
          <div className="text-center mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center group">
              <div className="glass-subtle p-8 rounded-2xl mb-4 group-hover:glass transition-all duration-300">
